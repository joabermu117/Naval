...
//Prueba de cuenta de github
    ...
    function generateOpponentBoard(boardState) {
        ...
        adjustBoardSize(opponentBoardDiv);
    ...
    function adjustBoardSize(board) {
        ...
        board.style.gridTemplateColumns = `repeat(${currentBoardSize}, ${cellSize}px)`;
    }
